...
import { Trash2, Search, ExternalLink, Mail, Phone, MapPin } from 'lucide-react'
                ...
                <AnimatePresence mode='popLayout'>
                    {filteredLeads.map((lead) => (
                        <motion.div
                            ...
                            className="group relative bg-slate-900/60 backdrop-blur-md border border-white/5 rounded-xl p-4 hover:bg-slate-800/60 hover:border-teal-500/20 transition-all duration-300 shadow-sm hover:shadow-lg"
                        >
